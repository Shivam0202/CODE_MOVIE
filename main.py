...
def Input(Page2):
    Page2.destroy()
    Page1 = Canvas(root)
    Page1.configure(bg='#cce6ff',width=1350,height=750)

    main_heading = Label(Page1, text="GENRE BASED MOVIE RECOMMENDER", fg="black", bg='#b366ff', height=2, width=0,font=("Times New Roman", 16,'bold'))
